...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-lg text-sm font-semibold whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/40 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-(--btn-shadow) hover:bg-primary-strong",
        clay: "bg-clay text-clay-ink shadow-(--clay-shadow) hover:bg-clay-strong",
        destructive:
          "bg-danger-soft text-danger-strong border border-danger-border hover:bg-danger-soft/70",
        outline:
          "border border-border-strong bg-surface text-text-strong shadow-xs hover:bg-hover",
        secondary:
          "bg-surface-2 text-text-strong border border-border hover:bg-hover",
        ghost: "text-text-strong hover:bg-hover",
